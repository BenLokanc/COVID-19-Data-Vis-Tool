...
#Creating dataframe of useful data from covid19dataexport.csv 
df = pd.DataFrame({'date': datelist, 'daily_cases': caselist}) 

#Creating sql database of values from dataframe
...
def plot_covid():
    try:
        ...
        fig1.suptitle("Plots of total cases and daily cases from March 6th to May 14th", horizontalalignment='center', fontsize= 12)
        FigureCanvas(fig1)
        ...
        plt.tight_layout(pad = 2.00, h_pad= 2.00)
        image1 = io.StringIO()
